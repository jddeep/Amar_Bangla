...
public class ColorsActivity extends AppCompatActivity {
   ...
   Word_Adapter adapter = new Word_Adapter(this, words,R.color.category_colors, mAudioManager);
...
//        FloatingActionButton floatingActionButton = listView.findViewById(R.id.fab);
